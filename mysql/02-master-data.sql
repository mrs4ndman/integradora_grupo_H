...
SET @uuid_usuario_empleado1 = UUID_TO_BIN(UUID());
...
SET @uuid_usuario_empleado4 = UUID_TO_BIN(UUID());
 ...
 INSERT INTO empleado (id, nombre, apellidos, fotografia, codigo_genero,
                       ...
                       acepta_informacion, cuenta_corriente_id, activo, version)
 VALUES (@uuid_usuario_empleado1,
         ...
         @departamento_admin, CURRENT_DATE, NULL, true,@uuid_cuenta_corriente1, 1, 0);
 ...
 VALUES (@uuid_usuario_empleado2,
         ...
         @departamento_admin, CURRENT_DATE, NULL, true, @uuid_cuenta_corriente2, 1, 0);
 ...
 VALUES (@uuid_usuario_empleado3,
         ...
         @departamento_venta, CURRENT_DATE, NULL, true, @uuid_cuenta_corriente3, 1, 0);
 ...
 VALUES (@uuid_usuario_empleado4,
         ...
         @departamento_prep, CURRENT_DATE, @uuid_usuario_empleado1, true, @uuid_cuenta_corriente4, 1, 0);
 ...
 INSERT INTO usuario (id, email, contrasena, cuenta_bloqueada, habilitado, intentos_fallidos, sesiones_totales,
...
INSERT INTO administrador (id, email, contrasena, cuenta_bloqueada, habilitado, intentos_fallidos,
                                  sesiones_totales)
